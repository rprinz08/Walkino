...
// serial port 0
#define SERIAL_0_PORT_NAME			    PORTE
#define SERIAL_0_USART_NAME			    USARTE0
#define SERIAL_0_USART_DATA			    USARTE0_DATA
#define SERIAL_0_RXC_ISR			      ISR(USARTE0_RXC_vect)
#define SERIAL_0_DRE_ISR			      ISR(USARTE0_DRE_vect)
...
const uint16_t PROGMEM digital_pin_to_control_PGM[] = {
	...
	(uint16_t) &PORTD_PIN2CTRL,  // PD 2 ** 2 **
	(uint16_t) &PORTD_PIN3CTRL,  // PD 3 ** 3 **
	(uint16_t) &PORTD_PIN4CTRL,  // PD 4 ** 4 **
	(uint16_t) &PORTD_PIN5CTRL,  // PD 5 ** 5 **
	(uint16_t) &PORTD_PIN6CTRL,  // PD 6 ** 6 ** LED green
	(uint16_t) &PORTD_PIN7CTRL,  // PD 7 ** 7 ** LED red
	...
	(uint16_t) &PORTE_PIN1CTRL,  // PE 1 ** 17 **
	(uint16_t) &PORTE_PIN2CTRL,  // PE 2 ** 18 ** USARTE_RX
	(uint16_t) &PORTE_PIN3CTRL,  // PE 3 ** 19 ** USARTE_TX
	...
	(uint16_t) &PORTA_PIN2CTRL,  // PA 2 ** 22 ** A2
	...
	(uint16_t) &PORTB_PIN1CTRL,  // PB 2 ** 29 ** A9
...
const uint8_t PROGMEM digital_pin_to_port_PGM[] = {
  ...
  _PE,  // PE 0 ** 16 **
  _PE,  // PE 1 ** 17 **
  _PE,  // PE 2 ** 18 ** USARTE_RX
  _PE,  // PE 3 ** 19 ** USARTE_TX
...
const uint8_t PROGMEM digital_pin_to_bit_mask_PGM[] = {
  ...
  _BV( 4 ),  // PD 4 ** 4 **
  _BV( 5 ),  // PD 5 ** 5 **
  _BV( 6 ),  // PD 6 ** 6 ** LED green
  _BV( 7 ),  // PD 7 ** 7 ** LED red
  ...
  _BV( 0 ),  // PE 0 ** 16 **
  _BV( 1 ),  // PE 1 ** 17 **
  _BV( 2 ),  // PE 2 ** 18 ** USARTE_RX
  _BV( 3 ),  // PE 3 ** 19 ** USARTE_TX
