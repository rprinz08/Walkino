...
// @@@
//volatile unsigned long timer0_test = 0;
...
unsigned long micros()
{
	...
	// for consistency, don't let this part get interrupted
	cli();
	...
	// which means I underflowed but didn't call the ISR yet
#ifdef TCC4
...
#endif
	{
		// increment ISR count for more accurate microseconds
		m++;
	}
...
void delayMicroseconds(unsigned int us)
{
	...
	// NOTE: for 16mhz clock, max time is 65536 / 4 or about 16k microsecs
...
////  TCC5_CTRLC = 0; // when timer not running, sets compare (13.9.3)
  ...
  // TCD2
  // first the clock selection @@@
  TCD0_CTRLA = 5; // b0101 - divide by 64 - A manual 14.12.1 page 163
  TCD0_CTRLB = 0; // compare outputs disabled on all 8 bits
  //TCD0_CTRLC = 0;
  TCD0_CTRLD = 0;
  TCD0_CTRLE = 0x2; // b10 - 'split' mode
#ifdef TCD0_CTRLFCLR
  TCD0_CTRLFCLR = 0xff;
#else // TCD0_CTRLFCLR
